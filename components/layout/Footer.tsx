    ...
    <footer className="mt-[60px] border-t border-line py-10 pb-[60px] grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr_1fr] gap-10">
      <div>
        ...
        <p className="text-[14px] text-ink-soft leading-[1.6] max-w-[36ch] mt-2">
          A direct-trade rice network linking farming villages with home kitchens.
          Built so farmers earn more and families pay less.
        </p>
      </div>
      <FooterCol
        heading="Buy"
      ...
      <FooterCol
        ...
        links={[
          ...
          { label: "Contact",       href: "/how-it-works" },
        ]}
      />
    </footer>
  );
